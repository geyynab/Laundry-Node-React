...
import { TableObjSix } from './Data';
import { Table } from '../../components';
import { Container, Button, ButtonSm } from '../../globalStyles';
        ...
        return(
            ...
            <Container>
                ...
                <div className="col-4">
                    ...
                    <br></br>
                    <NavLink to="/paket"> <ButtonSm primary><MdAdd />Add New Laundry Packet</ButtonSm></NavLink><br />
                <ButtonSm secondary onClick={() => this.checkOut()}>Continue to checkout</ButtonSm>
            </Container>
        )
        }
}
